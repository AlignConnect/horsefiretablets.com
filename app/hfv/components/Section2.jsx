...
const Section2 = () => {
    ...
    const listproductBene11 = [
        ...
        { title: 'जोश, उत्तेजना और इच्छा में वृद्धि', image: '/main/hfv_images/sec3_gif4.gif' },
    ]
                    ...
                    <div className="">
                        <div className="">
                            <div className="w-[100%] relative ">
                                <img src="/main/hfv_images/sec2_shape.webp" alt="pic" className="w-[100%] hidden md:block" />
                                <img src="/main/hfv_images/sec2_shape_mob.webp" alt="pic" className="w-[100%] block md:hidden" />
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {listproductBene11.map((e, key) => {
                                        return <div className="w-full text-center whyIntersted my-1" key={key}>
                                            <img src={e.image} alt="pic" className="md:w-[15rem] mx-auto md:h-[15rem] w-[10rem] h-[10rem] rounded-full" />
                                            <h1 className="text-black text-xl md:text-3xl mt-4 font-bold  font-sumana" >{e.title}</h1>
                                        </div>
                                    })}
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 mt-[10%] gap-0 md:gap-4">
                            <div className="">
                                <img src="/main/hfv_images/sec3_model.png" alt="pic" className="w-full" />
                            </div>
                            <div className="flex md:flex-col flex-col-reverse">
                                ...
                                <div className="mb-7 md:my-8 mt-0 " style={{ textAlign: 'center' }}>
            ...
            >
                <div className="max-w-7xl mx-auto px-2 md:pt-10">
                    ...
                    <div className="w-full py-6 md:py-12">
                        <img src="/main/hfv_images/sec4_awards.webp" alt="pic" className="w-full" />
                    </div>
                </div>
            </div>
