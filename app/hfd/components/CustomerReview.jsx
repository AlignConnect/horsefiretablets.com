                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <div className="flex flex-col ml-2">
                                        <img src={el.starimg} width={80} height={50} alt="pic" loading="lazy" />
                                        <div className="text-zinc-900 text-xl md:text-3xl mt-2  font-semibold py-2 flex justify-center items-center gap-2">
                                            <div>{el.name.charAt(0).toUpperCase() + el.name.slice(1)}</div> <div><img src={el.img} width={20} loading="lazy" alt="noimagesfo" /></div>
                                        </div>
                                    </div>
                                </div>
