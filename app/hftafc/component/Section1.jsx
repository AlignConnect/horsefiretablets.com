    ...
    return (
        <div>
            ...
            <div className='bg-[url(https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/4a77968d-2294-44a0-ec7e-7ccd8dae7f00/public)] bg-cover'>
                <div className='sm:w-[70%] mx-auto flex items-center py-5'>
                    <div>
                        <Form />
                    </div>
                </div>
            ...
            <div className=' bg-[url(https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/00712365-111b-4e6e-0dd2-977d0d547000/public)] text-white bg-cover pb-8' >
                <div className='fontNoto text-xl sm:py-5'>
                    <h1 className='sm:w-[60%] text-center font-semibold mx-auto text-2xl py-5'>अध्ययनों से पता चलता है कि विभिन्न क्षेत्रों में लिंग के औसत आकार में बड़ा अंतर होता है। अफ्रीकी देशों की आबादी अक्सर दक्षिण एशिया (भारत सहित) की तुलना में बड़े लिंग आकार की रिपोर्ट करती है।</h1>
                </div>

                <div className='flex items-center text-center text-white justify-center gap-5 px-2'>
                    <div>
                        <div>
            ...
            <div className='bg-[url(https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/395ee52a-6e8d-4765-13a0-56554b785200/public)] bg-cover py-8'>
                ...
                <div className='sm:w-[80%] mx-auto flex flex-wrap items-center justify-center gap-5'>
                    <div>
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/663fb255-bd42-4b5a-7e0d-8f270cdfbc00/public" alt="dsds" loading='lazy' className='px-2' />
                    </div>



                    <div className='px-2'>
                        <h1 className='fontAnton text-3xl sm:text-5xl text-center sm:text-start text-[#fceb15]'>PROBLEMS OF 70% OF INDIAN</h1>


                        <div className='flex items-start sm:items-center fontNoto text-xl sm:text-2xl pt-5 gap-3'>
            ...
            <div className='bg-[#fffee7] pt-12 pb-4'>
                ...
                <div className='sm:w-[70%] sm:py-8 mx-auto flex justify-center  flex-wrap-reverse sm:flex-nowrap items-center gap-5 px-2'>
                    ...
                    <div>
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/c4404ad4-7c66-412a-7e5d-a363e1e9dc00/public" alt="sdsd" loading='lazy' className='sm:min-w-[350px] max-w-[250px] sm:max-w-full' />
                    </div>
