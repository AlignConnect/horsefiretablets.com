        ...
        <div className="fontPoppins">
            <div className="bg-[#be3127]  text-white py-5 flex items-center justify-between">
                ...
                <div className="w-full sm:max-w-6xl mx-auto grid sm:grid-cols-2 justify-center items-center">
                    ...
                    <a href='#form' className="bg-yellow-400 fontJosefin sm:text-xl text-center text-black font-bold pt-1 pb-1 mt-3 sm:mt-0 px-4 rounded w-1/2 mx-auto box_shaddow animate-ease-in">
                        BUY NOW
                    </a>
