    ...
    return (
        <div className='w-full'>
            <section className='w-full py-3 md:py-7'>
                <div className='text-2xl md:text-4xl  text-white py-3  font-bold bg-gradient-to-t  from-[#071930] via-[#0d2950] to-[#133b72] mb-4 text-center'>What Our <span className="text-[#e91b1b]">Customers Say</span></div>
