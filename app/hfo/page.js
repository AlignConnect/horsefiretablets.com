...
const SexPower = dynamic(() => import('./component/SexPower'), {
    loading: () => <p>load</p>
});

const Vishesh_suvidha = dynamic(() => import('./component/Vishesh_suvidha'), {
    loading: () => <p>load</p>
});

const Turant_order = dynamic(() => import('./component/Turant_order'), {
    loading: () => <p>load</p>
});

const Sexlife_enjoy = dynamic(() => import('./component/Sexlife_enjoy'), {
    loading: () => <p>load</p>
});
...
const Tenx_powerfull = dynamic(() => import('./component/Tenx_powerfull'), {
    loading: () => <p>load</p>
});
