                    ...
                    <div className="mx-2 my-5 p-2 rounded-md" style={{ boxShadow: "-1px 0px 5px 0px black" }} key={key}>
                        ...
                        <div className="w-full md:w-[20rem] m-auto text-center">
                            ...
                            } */}
                            {
                                ...
                                key === 1 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/b15dfcf0-712c-4ad1-749a-38d3b6682d00/public" alt="no" loading='lazy' className='min-w-[200px] max-w-[300px]' width='100%' height='100%' />
                            }
                            {

                                key === 2 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/ce3611bd-2dc5-4d37-f080-47c4eb429700/public" alt="no" loading='lazy' className='min-w-[200px] max-w-[300px]' width='100%' height='100%' />
                            }

                            {
                                key === 5 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/a151ce1b-6321-4327-01c6-f6e72a537e00/public" alt="no" loading='lazy' className='min-w-[200px] max-w-[300px]' width='100%' height='100%' />
                            }

                            {
                                key === 10 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d28d6f15-4b96-4a08-e22a-84832551ad00/public" alt="no" loading='lazy' className='min-w-[200px] max-w-[300px]' width='100%' height='100%' />
                            }
                            ...
                            <div className="text-center">
                                <div className=" w-full" >{itemsToShow.length ? itemsToShow : "Loading..."}
                                    {numberOfitemsShown >= reviewsData.length ? (
                                        ...
                                        <button className='text-white font-bold px-3 my-3 pt-2 bg-[red] rounded-md' onClick={showMore}>Show more</button>
                                    )}
                                </div>
                            </div>
                        </div>
