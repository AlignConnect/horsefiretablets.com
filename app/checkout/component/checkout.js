...
export const handleCheckApiKey = () => {
  ...
  if (!apicheck) {
    ...
    switch (apicheck) {
      ...
      case "/hftjntf":
        get_next_url = process.env.NEXT_APP_URL_HFTJNTF;
        get_next_key = process.env.NEXT_APP_API_KEY_HFTJNTF;
        break;
      ...
      case "/hftvf":
        get_next_url = process.env.NEXT_APP_URL_HFTVF;
        get_next_key = process.env.NEXT_APP_API_KEY_HFTVF;
        break;
      ...
      case "/hftvhtf":
        get_next_url = process.env.NEXT_APP_URL_HFTVHTF;
        get_next_key = process.env.NEXT_APP_API_KEY_HFTVHTF;
        break;
