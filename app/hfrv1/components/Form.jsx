            ...
            <div className="">
                ...
                >
                    ...
                    <div className="py-6 md:py-12 px-3 ">
                        ...
                        <div className="flex items-center justify-center gap-3 sm:mx-20 mb-7">
                            <img src=" https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/40bbbac0-f037-4072-9cd9-552a62ae1500/public" alt="" className="w-16" />
                            <h1 className="fontNoto text-2xl md:text-3xl text-[#fdd909]  fw-bold font-extrabold">कॉल पर विशेषज्ञ डॉक्टरों से मुफ्त सलाह के लिए फॉर्म भरें!</h1>
                        </div>
                                    ...
                                    <div className="mx-auto font-poppin  bg-[#1a1a1a] text-white px-4 py-6 border border-dashed rounded-lg ">
                                        <div>
                                            <div className="text-center mb-7">
                                                <h1 className="text-center bg-white text-black px-2 text-3xl font-bold inline-block border-bottom "> Contact Us </h1>
                                            </div>
