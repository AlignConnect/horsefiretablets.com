...
function WhyChoose() {
    ...
    return (
        <div className='bg-black  text-center py-5 sm:pt-10 sm:pb-5'>

            <h1 className=" sm:w-11/12 mx-auto text-white px-3 text-2xl sm:text-5xl font-bold !leading-tight">Horse Fire Tablet के अद्भुत लाभ जो ग्राहक अनुभव करते है !</h1>
