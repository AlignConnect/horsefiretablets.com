        ...
        <div>
            ...
            <section className="w-full fontNoto ">
                ...
                <div className="max-w-4xl mx-auto px-3 pt-5 text-center md:py-10 min-h-[200px]">
                    ...
                    <div className="text-[1rem] md:text-2xl text-justify font-extrabold mb-4 italic">"लाखों पुरुष हॉर्सफायर के इस्तेमाल से लिंग बृद्धि और मनचाही सेक्स अवधि पाकर लाइफ को रंगीन बना चुके है ! आप किस इंतजार में है एक्सपर्ट्स से संपर्क करें अपनी समस्या बताएं और प्रोडक्ट आर्डर कर अपनी कमजोरी से छुटकारा पाएं।"</div>

                    <img
                        src={"/main/hflip_images/dhamaka_offer.png"}
                        loading="lazy"
                        className='mx-auto foo animate-foo w-48 md:w-1/3'

                    />

                    <div className="text-[1rem] md:text-2xl font-semibold my-5 md:my-10">जी हाँ, Summer "धमाका" Sale में ऑनलाइन पेमेंट पर प्रतिदिन 100 भाग्यशाली ग्राहकों को मिल रहा है हॉर्सफायर का पैक बिल्कुल फ्री! मौका हाथ से ना जाने दे, फ्री में हॉर्सफायर मंगाए। अगर आप भाग्यशाली हुए तो आपका भी पूरा पैसा आपके अकाउंट में ट्रांसफर कर दिया जायेगा!</div>
