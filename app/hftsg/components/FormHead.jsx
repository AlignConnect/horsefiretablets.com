...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefiretablets.com/HFTSG");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFTSG ?? "horsefiretablets.com/hftsg");
                                ...
                                <div>
                                    ...
                                    <form className="space-y-3">
                                        ...
                                        <div className="flex justify-center items-center pt-4 ">
                                            <button onClick={handleFormSubmit} type="button" className="bg-yellow-400 border border-yellow-400  text-xl font-bold p-3 pt-3 md:w-60 w-full  text-black rounded-tl-2xl rounded-br-2xl  hover:bg-yellow-500">
                                                SUBMIT
                                            </button>
                                        </div>
